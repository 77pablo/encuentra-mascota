...
export type Contexto = {
  ...
  // la 0022). OPCIONAL a propósito: si la consulta falla o la tabla `bloqueos`
...
export function resolverDestinatarios(evento: EventoAviso, ctx: Contexto): Destinatario[] {
  ...
  // interruptor de tipo: es opt-in explícito. Solo se respeta el filtro de
  // canales (y el bloqueo).
